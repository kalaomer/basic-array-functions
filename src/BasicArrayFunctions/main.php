...
/**
 * Yollanan array'ı EasyArray olarak döndürür.
...
/**
 * Referans olarak alınan Array'ı EasyArray nesnesine çevirir.
 * @param array reference $_
 * @return null
*/
function arr_convert( array $_ )
{
	return new EasyArray( $_ );
}

/**
 * EasyArray nesnesi ise true döndürür.
 * @param mixed $_
 * @return true|false
 */
function is_ar( $_ )
{
	return ($_ instanceof EasyArray);
}
